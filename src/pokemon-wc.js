...
class Media_Details extends HTMLElement {
  ...
  constructor() {
    ...
    if(this.type === 'song'){
      ...
      this.endPoint = `https://pokeapi.co/api/v2/pokemon/pikachu` // for testing
    }
    this.getDetails()
  }
  ...
  return string.charAt(0).toUpperCase() + string.slice(1);
    ...
    if(this.emptyResults(data)){
      ...
      if (this.type === 'song') {
        ...
        this.data.id  =  `000${this.data.id}`.slice(-3);
         this.blurBack.style.backgroundImage = `url( 'https://raw.githubusercontent.com/HybridShivam/Pokemon/master/assets/images/${this.data.id}.png' )`
        this.h1.innerText =  capitalizeFirstLetter(this.data.name)
        
        this.h4.innerText = this.data.types[0].type.name
        this.locandina.src = `https://raw.githubusercontent.com/HybridShivam/Pokemon/master/assets/images/${this.data.id}.png`
        

        
        this.blurBack.style.background =  `url( 'https://design-fenix.com.ar/codepen/pokedex/${data.types[0].type.name}.jpg' )`
